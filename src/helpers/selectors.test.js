...
const state = {
  days: 
  // [{"id":1,"name":"Monday","appointments":[1,2,3,4,5],"interviewers":[1,4,5,7,10],"spots":4},
  // {"id":2,"name":"Tuesday","appointments":[6,7,8,9,10],"interviewers":[1,2,5,6,8],"spots":4},
  // {"id":3,"name":"Wednesday","appointments":[11,12,13,14,15],"interviewers":[1,6,7,8,10],"spots":1},
  // {"id":4,"name":"Thursday","appointments":[16,17,18,19,20],"interviewers":[3,4,6,7,9],"spots":4},
  // {"id":5,"name":"Friday","appointments":[21,22,23,24,25],"interviewers":[3,6,7,8,10],"spots":2}],
  // [
  [  {
      id: 1,
      name: "Monday",
